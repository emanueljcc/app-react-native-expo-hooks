    ...
    return (
        <View>
            {userLogged ? (
                ...
                <View style={{ flex: 1 }}>
                    <Text style={{ textAlign: 'center', color: '#00a680', padding: 20,}} onPress={() => navigation.navigate('Login')}>
        ...
        <View style={styles.viewReview}>
            <View style={styles.viewImageAvatar}>
                <Avatar
                    ...
                    source={{ uri: avatarUser ? avatarUser : 'https://api.adorable.io/avatars/100/abott@adorable.png'}}
                />
            </View>
